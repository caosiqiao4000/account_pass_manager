 ...
 * </p>
 * 
 * @author Administrator 2015年12月30日 siqiao
 *
 */
public class MyDialogByFragment extends DialogFragment {
	 ...
	 *            View.OnClickListener 给左边的按钮设置监听器
	 * @param leftClickListener
	 *            View.OnClickListener 给右边的按钮设置监听器
	 * @param TouchOutside
	 *            是否在外面点击自动消失
	 */
	public MyDialogByFragment(Context context, Object titleText, Object contentText, Object leftText, Object rightText,
...
//			btnsLayout.setVisibility(View.GONE);
	 ...
	 *            是否要给右边的按钮设置监听器
	 */
	public MyDialogByFragment(Context context, Object titleText, Object contentText, Object leftText,
			Object rightText) {
		this.titleText = titleText;
		this.contentText = contentText;
		this.leftText = leftText;
	 ...
	 * 只显示一个按钮
	 */
	public MyDialogByFragment(Context context, Object titleText, Object contentText, Object leftText,OnClickListener leftClickListener, boolean touchOutside) {
		this.titleText = titleText;
		this.contentText = contentText;
		this.leftText = leftText;
		this.context = context;
	 ...
	 * 不要按钮
	 */
	public MyDialogByFragment(Context context, Object titleText, Object contentText, boolean touchOutside) {
		this.titleText = titleText;
		this.contentText = contentText;
		this.context = context;
		this.touchOutside = touchOutside;
