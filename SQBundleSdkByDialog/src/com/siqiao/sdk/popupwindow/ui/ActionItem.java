...
public class ActionItem {
    ...
    public ActionItem(int actionId, String title, Drawable icon) {
        this(actionId, title, icon, true);
    }
    public ActionItem(int actionId, String title, Drawable icon, boolean enable) {
        this.title = title;
        this.icon = icon;
...
//        d.setColorFilter(BLACK_CF);
     ...
     * @param selected 
     */
    public ActionItem(int actionId, String title,boolean selected) {
    	this.title = title;
        this.actionId = actionId;
