...
import com.siqiao.sdk.common.other.util.RResouceByWebUtil;
...
public class WebViewDialog extends WebChromeClient {
	...
	public WebViewDialog(Activity context, BaseWebViewDao webViewDao,
		...
		animal = AnimationUtils
				.loadAnimation(this.context, RResouceByWebUtil
						.getIdFromR_AnimClass(R.anim.sh_anim_progress));
